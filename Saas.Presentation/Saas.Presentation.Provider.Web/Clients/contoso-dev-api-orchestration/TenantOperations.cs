...
namespace Saas.Presentation.Provider.Web
{
    ...
    /// </summary>
    public partial class TenantOperations : IServiceOperations<ContosoDevApiOrchestration>, ITenantOperations
    {
        /// <summary>
        ...
        /// </param>
        public TenantOperations(ContosoDevApiOrchestration client)
        {
            if (client == null) 
            {
        ...
        /// <summary>
        /// Gets a reference to the ContosoDevApiOrchestration
        /// </summary>
        public ContosoDevApiOrchestration Client { get; private set; }
        ...
        public async Task<HttpOperationResponse<string>> GetByIdWithHttpMessagesAsync(int id, Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken))
        {
            ...
            // Construct URL
            var _baseUrl = this.Client.BaseUri.AbsoluteUri;
            var _url = new Uri(new Uri(_baseUrl + (_baseUrl.EndsWith("/") ? "" : "/")), "api/Tenant/{id}").ToString();
